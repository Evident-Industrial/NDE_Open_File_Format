...
The structure of the formatted JSON included in the **Setup** dataset can be validated against [a dedicated JSON schema](https://raw.githubusercontent.com/Evident-Industrial/NDE_Open_File_Format/refs/heads/main/schemas/Setup-Schema-4.4.0.json). 
