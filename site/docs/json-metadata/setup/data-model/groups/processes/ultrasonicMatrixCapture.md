...
| **digitalBandPassFilter**                                                                        | object | A [**digitalBandPassFilter**](#digitalbandpassfilter) object describing the applied filters for all beams |
| **waveforms** `required`                                                                         | array  | An array of [**waveforms**](#waveforms) objects describing the signal used for a given beam                |
| **beams**  `required`                                                                            | array  | An array of [**beams**](#beams) objects describing a sequence of emission and reception                    |
| If applicable, one of the following subobjects: [**planeWaveImaging**](#planewaveimaging) | object |                                                                                                                  |
...
<tbody>
  ...
  <tr>
    <td>The following subobject: 
        <ul>
            <li><b><a href="#pulse">pulse </a></b>  <code>required</code></li>
        </ul> 
    </td>
    <td>object</td>
    <td></td>
